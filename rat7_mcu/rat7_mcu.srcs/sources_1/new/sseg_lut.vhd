...
begin
    ...
    begin
        ...
        case lut_in is
            ...
            when "00000011" => seg <= "10100100"; --2
            when "00000111" => seg <= "10110000"; --3
            when "00001111" => seg <= "10011001"; --4
            when "00011111" => seg <= "10010010"; --5
            when "00111111" => seg <= "10000010"; --6
            when "01111111" => seg <= "11111000"; --7
            when "11111111" => seg <= "10000000"; --8
