...
HD_PWD='C:/Users/pangj/OneDrive - California Polytechnic State University/cpe233/hw3/hw3.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log keypad_drvr.vdi -applog -m64 -messageDb vivado.pb -mode batch -source keypad_drvr.tcl -notrace
