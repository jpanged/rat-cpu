...
HD_PWD='C:/Users/pangj/OneDrive - California Polytechnic State University/cpe233/hw2/hw2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spkr_drvr.vdi -applog -m64 -messageDb vivado.pb -mode batch -source spkr_drvr.tcl -notrace
